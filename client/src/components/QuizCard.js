    ...
    <div>
      {
        apiData.map((data_entry) => (
          <div>
            <h1 className='Quiz Category text-4xl text-center'>This is a {data_entry.category} Quizze</h1>
            <div className='box ml-40 mt-10 mr-40'>
              <div className='question border-2 rounded-2xl border-gray-800'>
                ...
                <div className='new_div ml-12 mt-2 mb-2 mr-12 flex flex-col flex-wrap '>
                  ...
                  <h5 className='Difficulty ml-4 text-base text-orange-600'>{data_entry.difficulty}</h5>
                </div>
                <div className='ml-12'>
                    ...
                    <form id='myform'>
                      <label onClick={() => { setAns(true); console.log(ans) }}>
                        <div className=' hover:bg-zinc-300 cursor-pointer rounded-lg duration-200'>
                          <input type='radio' name='question' class="w-3 h-3 mr-4 ml-2" />
                      ...
                      <div className=''>
                        ...
                        <div className='flex justify-end items-center'>
                          <button type='submit' className=' text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2' onClick={handleSubmit}>Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
